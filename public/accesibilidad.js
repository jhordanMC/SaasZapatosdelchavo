...
#accPanel .ap-tabs::-webkit-scrollbar-thumb{background:var(--s-border);border-radius:3px;}
  ...
  @media(max-width:680px){
    #accFab{width:58px;height:58px;bottom:16px;left:16px;}
...
(function(){
 ...
 function doReset(){
    ...
    const fab=$('#accFab');if(fab){fab.style.left='22px';fab.style.top='auto';fab.style.bottom='22px';fab.style.right='auto';fab.classList.remove('hidden','narrator-on');}
    syncAll();
