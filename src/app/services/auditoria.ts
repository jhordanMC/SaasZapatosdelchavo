...
export class AuditoriaService {
  ...
  listar(idEmpresa: string, filtros: FiltrosAuditoria = {}): Observable<ListaAuditoria> {
    ...
    return this.http.get<ListaAuditoria>(`${this.apiUrl}/empresas/${idEmpresa}/auditoria`, { params });
  }
}
